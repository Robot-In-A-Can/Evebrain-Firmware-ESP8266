...
function l10nMenu(el_id, languages){
  ...
  var li = document.createElement('li');
  li.innerHTML = '<a href="mailto:info@robotinacan.com?subject=eBrain%20Apps%20Translation&body=Hi,%20I\'d%20like%20to%20help%20by%20translating%20Mirobot%20Apps%20into...">Add language...</a>';
  menu.appendChild(li);
  new MainMenu(el);
}
