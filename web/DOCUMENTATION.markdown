...
This package contains all of the original code ([src/](./src/)),  and a custom build script with preprocessors. You'll be able to edit and build for a local synced dev experience.
...
|
|-- /src/ - Your code
|  |-- index.template.html - The wrapper for compiled HTML that includes any external stylesheets and scripts
